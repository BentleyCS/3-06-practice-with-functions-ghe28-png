...
def herons(num1,num2,num3):
    a=semiPerimeter(num1,num2,num3)-num1
    b=semiPerimeter(num1,num2,num3)-num2
    c=semiPerimeter(num1,num2,num3)-num3
    d=semiPerimeter(num1,num2,num3)
...
def plusMinus(num1,num2):
    product=num1*num2
    product1=product+num2
    product2 = product - num2
...
def quadratic(a,b,c):
    delta=b*b-4*a*c
    result=-b/2/a+math.sqrt(delta)/a/2
    return result
    pass
